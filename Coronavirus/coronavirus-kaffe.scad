...
module virus(knotter=8, tekst="", font="Arial") {
    difference() {
        ...
        */
        tekststr=radius*.17;
        circletext(tekst,myfont=font,textsize=tekststr,degrees=140,radius=radius-tekststr*1.5,top=true);
        circletext("roy@karlsbakk.net",myfont=font,textsize=tekststr*.7,degrees=140,radius=radius-tekststr*1.15,top=false);
        translate([-radius*.5,-radius*.55]) scale([radius/130,radius/130]) import("coffee.svg");
    }
}
t="SARS-CoV-2";
//t="Covid-19";
