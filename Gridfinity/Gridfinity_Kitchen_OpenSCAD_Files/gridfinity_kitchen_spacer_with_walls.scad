...
// these settings create a grdifinity box, cut off one wall on the X axis, but the box in half, duplicate the result and rotate is by 180 degrees. the result is a box with two wallcutouts.
GRIDFINITY_WIDTH=1;
GRIDFINITY_DEPTH=3;

mirror_part_offset = [GRIDFINITY_WIDTH*21,GRIDFINITY_DEPTH*21,0]; 
width = [GRIDFINITY_WIDTH, 0]; //0.1
depth = [GRIDFINITY_DEPTH, 0]; //0.1
height = [3, 0]; //0.1
lip_style = "none";
...
// gridfinitywidth+0.35, if gridfinitywidth=1 has to be set to 1.41
var_wallcutout_vertical_position = GRIDFINITY_WIDTH==1 ? 1.41 : GRIDFINITY_WIDTH+0.35;
wallcutout_vertical_position=var_wallcutout_vertical_position; 
wallcutout_vertical_width=42*1+18;
wallcutout_vertical_angle=90;
wallcutout_vertical_height=15.3;
//10, if gridfinitywidth=1 has to be set to 8.8
var_wallcutout_vertical_corner_radius = GRIDFINITY_WIDTH==1 ? 8.8 : 10;
wallcutout_vertical_corner_radius=var_wallcutout_vertical_corner_radius; 
extension_x_enabled = "front"; //[disabled, front, back]
extension_x_position = GRIDFINITY_WIDTH/2; //dridfinity width/2
...
// Remove some or all of lip
  // [ normal, reduced, minimum, none:not stackable ]
...
/* [Label] */
 //[disabled: no label, normal:normal, gflabel:gflabel basic label, pred:pred - labels by pred, cullenect:Cullenect click labels V2,  cullenect_legacy:Cullenect click labels v1]
...
/* [Wall Cutout] */
 //[disabled, enabled, wallsonly, frontonly, backonly]
