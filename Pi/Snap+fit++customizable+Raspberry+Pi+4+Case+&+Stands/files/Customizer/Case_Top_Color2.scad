...
module case_mesh() {
    ...
    if (Top_Style == "logo_mm2") {
        ...
        import(str("z_top", Case_Height_Prefix, "_style_logo_mm2_c2_base.stl"));
        
    } else if (Top_Style == "logo_mm3") {
        
        import(str("z_top", Case_Height_Prefix, "_style_logo_mm3_c2_base.stl"));
        ...
        if (Fan_Hole) {
            ...
            if (Fan_Type == "30mm") {
                import(str("z_top", Case_Height_Prefix, "_style_hex_mm2_c2_fan30_base.stl"));
            } else {
                import(str("z_top", Case_Height_Prefix, "_style_hex_mm2_c2_fan40_base.stl"));
            }
            
        } else {

            import(str("z_top", Case_Height_Prefix, "_style_hex_mm2_c2_base.stl"));
            
        }
            
    } else if (Top_Style == "pihole_mm4") {
        
        import(str("z_top", Case_Height_Prefix, "_style_pihole_mm4_c2_base.stl"));
...
module fan_hole_border_mesh() {
    ...
    if (Fan_Hole) {
        ...
        if (Fan_Type == "30mm") {
            import(str("z_top", Case_Height_Prefix, "_fan30_hole_border_mm2_c2_base.stl"));
        } else {
            import(str("z_top", Case_Height_Prefix, "_fan40_hole_border_mm2_c2_base.stl"));
        }
